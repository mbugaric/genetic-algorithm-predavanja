 ...
 * 
 * SUS selection
 * selection is performed in 1 round, and mating pool is filled immediately with 
 * MATING_POOL_SIZE individuals
 * 
 * Selection uses pointers and total fitness of population, as follows
 * 
 *  SUS(Population, N)
 *   F := total fitness of Population
 *   MATING_POOL_SIZE := number of offspring to newPopulation
 ...
 * 
 * Number of pointers defines how many copires of that individual will be copied
 * to the mating pool
 * 
...
(function () {
    ...
    function selection(N) {
        let matingPool = new Array();
        matingPool = stohUnivSelectionWithDebug(population, N);
        return matingPool;
    }
